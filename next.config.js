			...
			},
			{
				...
				headers: [
					...
					{ key: 'X-Content-Type-Options', value: 'nosniff' },
					{
						...
						value:
							"default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' *.tinymce.com *.tiny.cloud; connect-src 'self' *.tinymce.com *.tiny.cloud *.imgbb.com *.giphy.com api.giphy.com blob: wss://*.polkadot.io wss://*.onfinality.io wss://*.dwellir.com wss://*.pinknode.io wss://*.ibp.network wss://*.dotters.network wss://*.radiumblock.co wss://*.luckyfriday.io wss://*.subsquid.io wss://*.squids.live wss://*.stakeworld.io wss://*.composablenodes.tech wss://*.hydradx.cloud wss://*.helikon.io wss://*.paras.ibp.network wss://*.subscan.io https://*.subscan.io https://*.squids.live https://*.subsquid.io; img-src 'self' * data: blob:; style-src 'self' 'unsafe-inline' *.tinymce.com *.tiny.cloud; font-src 'self' *.tinymce.com *.tiny.cloud;"
					}
				]
			}
		];
