	...
	if (type === 'email') {
		...
		if (checkingVerified) {
			...
			const message = {
				...
				<br>If you're on mobile please paste this link to Nova wallet browser to continue: https://${network}.polkassembly.io/verify-email?token=${verificationToken}&identityVerification=${true}</br>
				<br/>
				<br>
				Thank you,
				</br>
