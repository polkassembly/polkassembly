...
const CalendarView: FC<ICalendarViewProps> = ({
	...
	const [sidebarCreateEvent, setSidebarCreateEvent] =
	...
	return (
		<>
			<div
				className={`${className} bg-white drop-shadow-md p-3 rounded-xl`}
			>
				...
				{accessible && (
					<div className="event-bot-div">
						...
						>
							{queryApprovalStatus == approvalStatus.APPROVED
								? 'Show'
								: 'Hide'}{' '}
							Pending Events
						</Button>
					...
					<div className="events-sidebar">
						...
						<div className="event-sidebar-header d-flex">
							<div className="d-flex">
								...
								></div>
								<h1 className="dashboard-heading mb-2">
									{sidebarEvent.title}
								</h1>
							</div>
						</div>
						...
						<div className="sidebar-event-datetime">
							<span>
								{dayjs(sidebarEvent.end_time).format('MMMM D')}
							</span>{' '}
							<span>
								{dayjs(sidebarEvent.end_time).format('h:mm a')}
							</span>
						</div>
