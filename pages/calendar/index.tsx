...
const CalendarView: FC<ICalendarViewProps> = ({ className, small = false, emitCalendarEvents = undefined, network }) => {
	...
	return (
		<>
			<div className={`${className} bg-white dark:bg-section-dark-overlay drop-shadow-md p-3 rounded-xl`}>
			...
			{sidebarEvent && <SidebarRight open={sidebarEvent} closeSidebar={() => setSidebarEvent(false)}>
				<div className="events-sidebar" >
					...
					<div className='approval-status-div'>
						...
						<Button onClick={handleUpdateApproval}
							// disabled={loadingUpdate}
						>Save</Button>
					</div>
					}
					...
					<div className="sidebar-event-links">
						<h3 className='dashboard-heading flex items-center gap-x-2 mb-2'> <Image alt='link' src={chainLink} height={16} width={16} /> Relevant Links</h3>
