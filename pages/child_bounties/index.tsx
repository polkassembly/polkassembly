    ...
    <>
      ...
      <div className="flex flex-col md:flex-row">
        <p className="text-bodyBlue text-sm font-medium bg-white p-4 md:p-8 rounded-xxl w-full shadow-md mb-4">
          This is the place to discuss on-chain child bounties. Child Bounty
          posts are automatically generated as soon as they are created
      ...
      <div className="shadow-md bg-white py-5 px-0 rounded-xxl mt-6">
        ...
        <div>
          <Listing posts={posts} proposalType={ProposalType.CHILD_BOUNTIES} />
