...
export const getServerSideProps: GetServerSideProps = async ({
  ...
  const { trackId } = networkTrackInfo[network][PostOrigin.FELLOWSHIP_ADMIN];
...
interface IFellowshipAdminProps {
  ...
  return (
    <>
      <SEOHead
        ...
        network={network}
      />
      <TrackListing trackName={PostOrigin.FELLOWSHIP_ADMIN} posts={posts} />
    </>
  );
};
