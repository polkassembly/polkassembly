...
export const getServerSideProps: GetServerSideProps = async ({
    ...
    const fetches = fellowshipReferendumPostOrigins.reduce(
        (prev: any, currTrackName) => {
            const trackId: any =
                networkTrackInfo?.[network]?.[currTrackName]?.trackId;
...
const FellowshipAdmin: FC<IFellowshipReferendumProps> = (props) => {
    ...
    return (
        <>
            ...
            <TrackListing
                posts={posts}
                fellowshipReferendumPostOrigins={
                    fellowshipReferendumPostOrigins
                }
            />
        </>
