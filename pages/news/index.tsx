...
const News: FC<Props> = ({ data, error, network }) => {
  ...
  const isPolkadotOrKusama =
    profile === Profile.Kusama || profile === Profile.Polkadot;
  const profile2 =
    profile === Profile.Kusama ? Profile.Polkadot : Profile.Kusama;
          ...
          <article className="flex-1 max-w-[720px] justify-center">
            {isPolkadotOrKusama && (
              <div className="flex items-center mb-2">
                ...
                />
                <h4 className="text-[18px] font-medium text-sidebarBlue ml-2">
                  {profile === Profile.Kusama ? 'Kusama' : 'Polkadot'}
                </h4>
              </div>
            )}
            ...
            <article className="flex-1">
              {isPolkadotOrKusama && (
                <div className="flex items-center mb-2">
                  <Image
                    src={
                      profile2 === Profile.Kusama ? kusamaLogo : polkadotLogo
                    }
                    className="rounded-full"
                    height={28}
                    width={28}
