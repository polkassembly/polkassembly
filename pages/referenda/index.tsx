	...
	return (
		<>
			...
			<div className='flex items-center mt-3'>
				...
				<h1 className='text-bodyBlue font-semibold text-2xl mx-2'>On Chain Referenda ({count})</h1>
			</div>

			{/* Intro and Create Post Button */}
			<div className="flex flex-col md:flex-row">
				<p className="text-bodyBlue text-sm font-medium bg-white max-md:p-4 px-6 rounded-xxl w-full shadow-md">
