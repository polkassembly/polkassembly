...
const TermAndCondition = (props: any) => {
	...
	return (
        ...
        .polkassembly.io/privacy)</p>.
			...
			<Wrapper>
				<CustomHeading className="mb-4 text-black">2. The Forum</CustomHeading><p>1. The Forum is made available free of charge. We do not guarantee that
        ...
        Forum is unavailable at any time or for any period. We may update the Forum and/or change the content on it at any time.</p><p>2. You are responsible for making all arrangements necessary for you to have access to the Forum. You are also responsible for ensuring that all persons who
        access the Forum through your internet connection are aware of these Terms and that they comply with them.</p><p>3. The Forum and the content on it are provided for general information purposes only. They are not intended to amount to advice on which you should rely.</p>

			</Wrapper>

			<Wrapper>
				<CustomHeading className="mb-4 text-black">3. Your account and password</CustomHeading><p> 1. You will need to register an account with us on the Website in order
        ...
        attribution with respect to your User Generated Content.</p>
			...
			<Wrapper>
				...
				<p>1. death or personal injury caused by our negligence; </p><p>2. fraud or fraudulent
        misrepresentation; and</p> <p>3. any matter in respect of which it would be unlawful for us to exclude or restrict our liability.</p> <p> 2. We assume no
        ...
        that may arise from your use of them</p><p>3. We make no representations about the reliability, availability, timeliness or accuracy of the
        ...
        Terms, whether in contract (including under any indemnity), tort (including negligence) or otherwise shall be limited to EUR 100.</p> <p>You
        ...
        affiliates as a result of any breach of these Terms.</p> <p> If you are a consumer </p> <p>If you are acting for purposes that are wholly or mainly
