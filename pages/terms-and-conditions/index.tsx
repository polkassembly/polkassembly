...
const TermAndCondition = (props: any) => {
	...
	return (
        ...
        linnaosa, Tallinn,Harju maakond, 10145 (the <strong>Company</strong>). The Company
        operates Polkassembly (the <strong>Forum</strong>) on https://${network}
        ...
        included in brackets and speech marks).</p>
        ...
        user agreement shall prevail;</p>
					<p className='mb-[2px]'> 2.the Website uses cookies, the use of
        which are governed by our cookies policy (available https://premiurly.in/policy/);</p>
					<p className='mb-[2px]'>3.we only use your personal information
        ...
        Forum is unavailable at any time or for any period. We may update the Forum and/or change the content on it at any time.</p>
					<p className='mb-[2px]'>2. You are responsible for making all arrangements necessary for you to have access to the Forum. You are also responsible for ensuring that all persons who
        access the Forum through your internet connection are aware of these Terms and that they comply with them.</p>
					<p className='mb-[2px]'>3. The Forum and the content on it are provided for general information purposes only. They are not intended to amount to advice on which you should rely
        ...
        party.</p><p className='mb-[2px]'>2. We have the right to disable any Accounts and/or passwords, at
        any time, if in our reasonable opinion you have failed to comply with
        any of the provisions of these Terms.</p><p className='mb-[2px]'>3. If you know or suspect that
        anyone other than you knows your Account login details, you must
        immediately notify us at contact@premiurly.in.</p>
					<p className='mb-[2px]'>4. You are responsible
        for any unauthorised use of your Account login details.</p><p className='mb-[2px]'>5. If you are
        ...
        or music (unless it is your own);</p> <p className='mb-[2px]'>7. it must not contain someone else’s
        personal details or confidential information relating to other people;</p>
					<p className='mb-[2px]'>8. it must not promote discrimination, whether based on race, sex,
        religion, nationality, disability, sexual orientation or age</p><p className='mb-[2px]'>9. it must
        not promote or condone terrorism, violence or illegal behaviour;</p > <p className='mb-[2px]'>10. it
        must not be harmful to minors in any way; </p><p className='mb-[2px]'>11. it must not promote any
        ...
        recommend that you use your own virus protection software.</p><p> 2. You must
        ...
        documents referred to in it. We reserve all other rights.</p>
					<p className='mb-[2px]'>2. We are the
        ...
        reserved.</p> <p className='mb-[2px]'>3. You are not granted any right to use, and may not use, any
        ...
        for internal, non-commercial, personal use by you.</p>  <p className='mb-[2px]'>4. Save as required
        ...
        different user) the prior written consent of that user.</p> <p className='mb-[2px]'>5. You retain
        ...
        misrepresentation; and</p> <p className='mb-[2px]'>3. any matter in respect of which it would be unlawful for us to exclude or restrict our liability.</p> <p className='mb-[2px]'> 2. We assume no
        responsibility for the content of websites, web applications or mobile applications linked to from the Forum (including links to any third
        party browser extensions providing voting functionality or notification facilities or links to our commercial sponsors and partners). Such links
        should not be interpreted as endorsement by us of those linked websites or mobile applications. We will not be liable for any loss or damage
        that may arise from your use of them</p><p className='mb-[2px]'>3. We make no representations about the reliability, availability, timeliness or accuracy of the
        content included on the Forum.</p> <p>If you are a business</p> <p>If you are acting for purposes relating to your trade, business, craft or profession, then
        subject to clause 6.1:you agree to use the Forum for internal purposes only and in no event shall we be liable to you for any loss of profits,
        loss of revenue, loss of contracts,failure to realise anticipated savings or for any indirect or consequential loss, whether arising from
        negligence, breach of contract or otherwise; and our total liability to you for any loss or damage arising out of or in connection with these
        Terms, whether in contract (including under any indemnity), tort (including negligence) or otherwise shall be limited to EUR 100.</p> <p className='mb-[2px]'>You
        shall indemnify and hold us harmless against any losses, costs, liabilities and expenses suffered or incurred by us and/or our
        affiliates as a result of any breach of these Terms.</p> <p className='mb-[2px]'> If you are a consumer </p> <p className='mb-[2px]'>If you are acting for purposes that are wholly or mainly
        outside your trade, business, craft or profession then, save as set out in clause 6.1, the following sub-clauses apply. 1.If we fail to comply
        with these Terms, we are responsible for loss or damage you suffer that is a foreseeable result of our breach of these Terms or our
        negligence,but we are not responsible for any loss or damage that is not foreseeable. Loss or damage is foreseeable if it was an obvious
        consequence of our breach or if it was contemplated by you and us at the time that you accessed the Forum 2. Our total liability to you for any
        loss or damage arising out of or in connection with these Terms, whether in contract (including under any indemnity), tort (including negligence)
        or otherwise shall be limited to EUR 100 3.Nothing in these Terms affects your statutory rights. Advice about your statutory rights is
        available from your local Citizens Advice Bureau or Trading Standards Office.4 You agree not to use the Forum,or any content on the Forum, for
        any commercial or business purposes and we have no liability to you for any loss of profit, loss of business, business interruption, or loss of
        ...
        Terms, we may immediately do any or all of the following (withoutlimitation):</p> <p className='mb-[2px]'>1. issue a warning to you; </p><p className='mb-[2px]'>3.
        temporarily or permanently withdraw your right to use the Forum</p><p className='mb-[2px]'>4.suspend or terminate your Account;</p> <p className='mb-[2px]'>5. issue legal proceedings against
        you for reimbursement of all costs resulting from the breach (including, but not limited to, reasonable administrative and legal costs);</p> <p className='mb-[2px]'>6. take
        further legal action against you; and/or</p> <p className='mb-[2px]'>7. disclose such information to law enforcement authorities as we reasonably feel is necessary to do so.</p>
					<p className='mb-[2px]'>3. If we withdraw your right to use the Forum, then:</p><p className='mb-[2px]'> 1. all rights granted to you under these Terms shall cease;</p><p className='mb-[2px]'>2. you must immediately cease all activities authorised by these Terms, including your use of any services provided through the Forum.</p>
				</StyledParagraph>
			</Wrapper>
			<Wrapper>
        ...
        effect.</p>
					<p className='mb-[2px]'>2. If we fail to insist that you perform any of your obligations
        ...
        later default by you.</p> <p className='mb-[2px]'>3. If you wish to have more information on online
        ...
        law.</p><p className='mb-[2px]'>The courts of Estonia will have non-exclusive jurisdiction over
        any disputes between us and you (including non-contractual disputes or
        claims). </p> If you are a consumer <p className='mb-[2px]'>1. These Terms are governed by the laws
        ...
        non-contractual disputes or claims), will be governed by Estonian law.</p>
					<p className='mb-[2px]'>You may bring any dispute which may arise under these Terms to – at
        ...
        an EU Member State, or otherwise the competent court of Estonia.</p><p className='mb-[2px]'>As a
