...
const Tips: FC<ITipsProps> = (props) => {
	...
	return (
		<>
			...
			<h1 className='dashboard-heading mb-4 flex md:mb-6'><TipIcon className='mt-[-8px]'/> On Chain Tips ({count})</h1>
			...
			<div className='shadow-md p-3 md:p-0 rounded-[14px] bg-white'>
