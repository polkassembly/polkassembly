...
const messages = {
	...
	ADDRESS_ALREADY_EXISTS:
		'This address is already linked with another account. Please choose another address.',
	...
	ADDRESS_LINKING_STARTED:
		'Address Linking started. Please sign the message with your account to link address',
	ADDRESS_LINKING_SUCCESSFUL:
		'Address is successfully linked to your account.',
	ADDRESS_LOGIN_INVALID_SIGNATURE:
		'Login with web3 account failed. Invalid signature.',
	ADDRESS_LOGIN_NOT_FOUND:
	...
	ADDRESS_SIGNUP_ALREADY_EXISTS:
		'There is already an account associated with this address, you cannot sign-up with this address.',
	ADDRESS_SIGNUP_INVALID_SIGNATURE:
		'Signup with web3 account failed. Invalid signature.',
	ADDRESS_SIGNUP_SIGN_MESSAGE_EXPIRED:
		'Session expired, please signup again.',
	ADDRESS_SIGNUP_STARTED: 'Please sign and send following message to signup.',
	ADDRESS_UNLINKING_SUCCESS:
		'Address is successfully removed from your account.',
	ADDRESS_UNLINK_NOT_ALLOWED:
		'You cannot unlink default address from your account.',
	...
	CREATE_POST_STARTED:
		'Post creation started. Please sign the message with your account to create post',
	CREDENTIALS_CHANGE_SUCCESSFUL: 'Username and password added successfully',
	EDIT_POST_STARTED:
		'Post edit started. Please sign the message with your account to edit post',
	EMAIL_CHANGE_NOT_ALLOWED_YET:
		'Email change not allowed. Please wait 48 hours after last email change.',
	EMAIL_CHANGE_REQUEST_SUCCESSFUL:
		'Email changed. Verification request sent to your email address.',
	...
	ERROR_CREATING_USER_PREFERENCE:
		'There was an error creating user preference.',
	...
	ERROR_UPDATING_USER_PREFERENCE:
		'There was an error updating user preference.',
	...
	EVENT_USER_NOTIFICATION_PREFERENCE_FALSE:
		'Notification preference is set to not send email.',
	...
	MULTISIG_ADDRESS_ALREADY_EXISTS:
		'This multisig address already linked with another account.',
	MULTISIG_NOT_ALLOWED:
		'Given address is not one of the multisig signatories',
	...
	NOTIFICATION_PREFERENCE_CHANGE_SUCCESSFUL:
		'Notification preference changed successfully.',
	...
	OLD_AND_NEW_PASSWORD_MUST_DIFFER:
	...
	POST_CREATE_SIGN_MESSAGE_EXPIRED:
		'Session expired, please create post again.',
	...
	REPORT_COMMENTS_LENGTH_EXCEEDED:
		'Report comments can be max 300 character long.',
	...
	RESEND_VERIFY_EMAIL_TOKEN_REQUEST_SUCCESSFUL:
		'A new verification mail has been sent to your email.',
	RESET_PASSWORD_RETURN_MESSAGE:
		'The reset password link was sent to this email, if it exists in our database.',
	SET_CREDENTIALS_INVALID_SIGNATURE:
		'Failed to set up a username and password. Invalid signature.',
	...
	SUBSCRIPTION_EMAIL_UNVERIFIED:
		'Please verify your email to receive subscription emails.',
	...
	SUCCESS: 'Success.',
	TWO_FACTOR_AUTH_INVALID_AUTH_CODE:
	...
	TWO_FACTOR_AUTH_TOKEN_EXPIRED:
		'Two factor authentication token expired. Please login again.',
