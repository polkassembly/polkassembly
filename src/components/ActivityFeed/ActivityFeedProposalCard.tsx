			...
			<div className='mt-5 rounded-xxl border-[0.6px] border-solid border-[#D2D8E0] bg-white p-5 text-[13px] dark:border-[#4B4B4B] dark:bg-section-dark-overlay md:p-5'>
				<div className='flex items-center justify-between gap-2'>
					<div className='flex items-center'>
						<div>
							<p className='whitespace-nowrap pt-3  font-semibold text-[#243A57] dark:text-white xl:text-[15px] 2xl:text-[18px]'>{t('voted_proposals')}</p>
						</div>
				...
				<div>
					<p className='text-blue-light-medium dark:text-[#9E9E9E]'>
						<span className='text-xl font-semibold text-pink_primary'>{proposaldata?.totalVotes}</span> {t('out_of')}{' '}
						<span className='text-md font-semibold text-blue-light-medium dark:text-[#9E9E9E]'>{proposaldata?.activeProposals}</span> {t('active_proposals')}
					</p>
				</div>
			</div>
		</div>
