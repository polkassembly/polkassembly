                ...
                <div className="flex flex-col md:flex-row">
                    ...
                    <div>
                        ...
                        <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-sidebarBlue sm:mx-0 sm:max-w-xs sm:text-left">
                            Polkassembly is a unified platform to discuss and
                            vote on governance proposals, motions and
                            referandas.
                        </p>

                        <h2 className="mt-8 text-sidebarBlue text-sm capitalize text-center md:text-left">
                            {network} Network Links:{' '}
                        </h2>
                        <div className="mt-3 flex justify-center md:inline-block">
                            {!error && socials && socialLinks(socials)}
                        </div>
                    </div>
                    ...
                    <div className="mt-10 md:mt-0 mx-auto md:mx-0 md:ml-auto flex flex-col md:flex-row justify-center md:justify-end">
                        <div className="md:ml-10 lg:ml-14 text-center sm:text-left">
                            <p className="text-lg font-medium text-sidebarBlue">
                                Help Center
                            </p>
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
                            &copy; Polka Labs Private Limited{' '}
