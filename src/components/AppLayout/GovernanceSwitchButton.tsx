...
const GovernanceSwitchButton = ({ className } : Props) => {
	...
	return (
		<div className={`${className}`}>
			<div className='m-0 border border-solid border-[rgba(72,95,125,0.2)] rounded-full flex items-center justify-center min-w-[200px] p-2 py-1' onClick={handleClick}>
