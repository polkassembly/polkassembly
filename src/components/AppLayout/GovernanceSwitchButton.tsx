	...
	return (
		<div className={`${className}`}>
			<Link
				...
				href='/'
			>
				<p className='m-0 text-[10px] font-normal leading-[15px] tracking-[0.02em] text-sidebarBlue'>{t('switch_to')}</p>
				<p className='m-0 ml-[6px] mr-[11px] font-dmSans text-xs font-semibold leading-[18px] tracking-[0.02em] text-sidebarBlue'>
					{isOpenGovSupported(network) ? t('open_gov') : t('governance_v1')}
				</p>
