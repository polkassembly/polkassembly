...
const AppLayout = ({ className, Component, pageProps }: Props) => {
	...
	const gov1Items: { [x: string]: ItemType[] } = {
		overviewItems: [
			!isMobile
				...
				: null,
			getSiderMenuItem('Overview', '/', <OverviewIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
			getSiderMenuItem('Discussions', '/discussions', <DiscussionsIcon className='ant-menu-item-icon mt-1.5 font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
			getSiderMenuItem('Calendar', '/calendar', <CalendarIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
			// getSiderMenuItem('News', '/news', <NewsIcon className='text-lightBlue font-medium  ant-menu-item-icon dark:text-icon-dark-inactive' />),
			getSiderMenuItem('Parachains', '/parachains', <ParachainsIcon className='ant-menu-item-icon mt-3 font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
		],
		democracyItems: chainProperties[network]?.subsquidUrl
			? [
					getSiderMenuItem('Proposals', '/proposals', <DemocracyProposalsIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
					getSiderMenuItem('Referenda', '/referenda', <ReferendaIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
			  ]
			: [],
		councilItems: chainProperties[network]?.subsquidUrl
			? [
					getSiderMenuItem('Motions', '/motions', <MotionsIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
					getSiderMenuItem('Members', '/council', <MembersIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
			  ]
			: [],
		treasuryItems: chainProperties[network]?.subsquidUrl
			? [
					getSiderMenuItem('Proposals', '/treasury-proposals', <TreasuryProposalsIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
					getSiderMenuItem('Tips', '/tips', <TipsIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
			  ]
			: [],
		techCommItems: chainProperties[network]?.subsquidUrl
			? [getSiderMenuItem('Proposals', '/tech-comm-proposals', <TechComProposalIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />)]
			: [],
		allianceItems: chainProperties[network]?.subsquidUrl
			? [
					getSiderMenuItem('Announcements', '/alliance/announcements', <NewsIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
					getSiderMenuItem('Motions', '/alliance/motions', <MotionsIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
					getSiderMenuItem('Unscrupulous', '/alliance/unscrupulous', <ReferendaIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
					getSiderMenuItem('Members', '/alliance/members', <MembersIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
			  ]
			: [],
		PIPsItems:
			chainProperties[network]?.subsquidUrl && network === 'polymesh'
				? [
						getSiderMenuItem('Technical Committee', '/technical', <RootIcon className='ant-menu-item-icon mt-1.5 font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
						getSiderMenuItem(
							'Upgrade Committee',
							'/upgrade',
							<UpgradeCommitteePIPsIcon className='ant-menu-item-icon mt-1.5 font-medium  text-lightBlue dark:text-icon-dark-inactive' />
						),
						getSiderMenuItem('Community', '/community', <CommunityPIPsIcon className='ant-menu-item-icon mt-1.5 font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
				  ]
				: []
	};
	if (isGrantsSupported(network)) {
		gov1Items['overviewItems'].splice(
			3,
			0,
			getSiderMenuItem('Grants', '/grants', <BountiesIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
		);
	}
			...
			getSiderMenuItem(
				...
				isOpenGovSupported(network)
					? ![AllNetworks.MOONBEAM, AllNetworks.MOONBASE, AllNetworks.MOONRIVER].includes(network)
						...
						? [
								...[
									getSiderMenuItem('Bounties', '/bounties', <BountiesIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
									getSiderMenuItem(
										'Child Bounties',
										'/child_bounties',
										<ChildBountiesIcon className='ant-menu-item-icon ml-0.5 text-2xl  font-medium text-lightBlue dark:text-icon-dark-inactive' />
									)
								]
						  ]
						: [
	...
	if (network === AllNetworks.COLLECTIVES) {
		const fellowshipItems = [
			getSiderMenuItem('Members', '/fellowship', <MembersIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
			getSiderMenuItem('Member Referenda', '/member-referenda', <FellowshipGroupIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
		];
		items = [
				...
				default: {
					const icon =
						trackName === PostOrigin.ROOT ? (
							<RootIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />
						) : trackName === PostOrigin.AUCTION_ADMIN ? (
							<AuctionAdminIcon className='ant-menu-item-icon mt-[1px] font-medium text-lightBlue dark:text-icon-dark-inactive' />
						) : (
							<StakingAdminIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />
						);
	...
	const gov2OverviewItems = [
		!isMobile
			...
			: null,
		getSiderMenuItem('Overview', '/opengov', <OverviewIcon className='ant-menu-item-icon mt-1 font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
		getSiderMenuItem('Discussions', '/discussions', <DiscussionsIcon className='ant-menu-item-icon mt-1.5 font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
		getSiderMenuItem('Calendar', '/calendar', <CalendarIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
		// getSiderMenuItem('News', '/news', <NewsIcon className='text-lightBlue font-medium  ant-menu-item-icon dark:text-icon-dark-inactive' />),
		getSiderMenuItem('Parachains', '/parachains', <ParachainsIcon className='ant-menu-item-icon mt-2.5 font-medium  text-lightBlue dark:text-icon-dark-inactive' />),
		getSiderMenuItem('Preimages', '/preimages', <PreimagesIcon className='ant-menu-item-icon mt-1 font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
	];
	...
	if (['kusama', 'polkadot'].includes(network)) {
		gov2OverviewItems.splice(
			3,
			0,
			getSiderMenuItem('Delegation', '/delegation', <DelegatedIcon className='ant-menu-item-icon mt-1.5 font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
		);
	}
	if (isGrantsSupported(network)) {
	...
	let gov2Items: MenuProps['items'] = [
		...
		getSiderMenuItem('Governance', 'gov2_governance_group', <GovernanceGroupIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />, [
			...gov2TrackItems.governanceItems
		]),
		getSiderMenuItem('Whitelist', 'gov2_fellowship_group', <FellowshipGroupIcon className='ant-menu-item-icon mt-1 font-medium text-lightBlue dark:text-icon-dark-inactive' />, [
	...
	if (isFellowshipSupported(network)) {
		gov2Items.splice(
			...
			getSiderMenuItem(
				...
				<FellowshipGroupIcon className='ant-menu-item-icon mt-1 font-medium  text-lightBlue dark:text-icon-dark-inactive' />,
				[...gov2TrackItems.fellowshipItems]
			)
		);
	}
	...
	if (![AllNetworks.MOONBASE, AllNetworks.MOONBEAM, AllNetworks.MOONRIVER].includes(network)) {
		if (network !== 'picasso') {
			...
			gov2Items.splice(
				-1,
				0,
				getSiderMenuItem('Treasury', 'gov2_treasury_group', <TreasuryGroupIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />, [
					...items
				])
			);
		} else {
	...
	if (isFellowshipSupported(network)) {
		gov2CollapsedItems.splice(
			...
			1,
			getSiderMenuItem('Fellowship', 'gov2_fellowship_group', <FellowshipGroupIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />, [
				...gov2TrackItems.fellowshipItems
			])
		);
	}
	...
	if (network === AllNetworks.MOONBEAM) {
		gov2Items = gov2Items.concat(
			getSiderMenuItem(
				'Treasury',
				'gov1_treasury_group',
				<TreasuryGroupIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />,
				gov1Items.treasuryItems
			)
		);
		gov2CollapsedItems = [
	...
	if (network !== AllNetworks.POLYMESH) {
		gov2Items = [
			...gov2Items,
			getSiderMenuItem('Archived', 'archived', <ArchivedIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />, [...items])
		];
		gov2CollapsedItems = [
			...gov2CollapsedItems,
			getSiderMenuItem('Archived', 'archived', <ArchivedIcon className='ant-menu-item-icon font-medium  text-lightBlue dark:text-icon-dark-inactive' />)
		];
	}
	...
	return (
		<Layout className={className}>
			<Sider
				...
				className={'sidebar sticky bottom-0 top-0 hidden h-screen overflow-y-hidden bg-white dark:bg-section-dark-overlay lg:block'}
			>
				{!sidedrawer ? (
					<div className='mb-[6px]'>
						<img
							src={theme === 'dark' ? '/assets/PALogoDark.svg' : '/assets/pa-logo-black.svg'}
							alt='polkassembly logo'
							className='mx-[18px] hidden pt-[10px] lg:block'
						/>
						<div className='mx-7 mt-3 flex items-center justify-between '>
							<h2 className='text-container my-auto capitalize text-bodyBlue dark:text-blue-dark-high lg:text-base lg:font-semibold lg:leading-[21px] lg:tracking-[0.02em]'>
								{network}
							</h2>
							<Button
								type='text'
					...
					<div className='mx-auto mb-[10px] flex w-full flex-col justify-center'>
						<span className='ml-4 mt-[10px] '>
				...
				<div className='flex h-[calc(100vh-110px)] flex-col justify-between space-y-3 overflow-y-auto'>
					<Menu
						theme={theme}
						mode='inline'
			...
			<Layout>
				...
				<div className='block lg:hidden'>
					...
					>
						<div
							className='flex h-full flex-col justify-between pb-3 pt-2'
