...
const Balance = ({ address, onChange, isBalanceUpdated, setAvailableBalance, classname }: Props) => {
	...
	return (
		<div className={`${poppins.className} ${poppins.variable} dark:text-blue-dark-medium ml-auto text-xs font-normal tracking-[0.0025em] text-[#576D8B] mr-[2px]${classname}`}>
