            ...
            <div className="create-event-form">
                <Form>
                    <div>
                        ...
                        <Form.Item
                            validateStatus={
                                errorsFound.includes("eventTitle")
                                    ? "error"
                                    : ""
                            }
                        >
                    ...
                    <div>
                        ...
                        <Form.Item
                            validateStatus={
                                errorsFound.includes("eventDescription")
                                    ? "error"
                                    : ""
                            }
                        >
                    ...
                    <div className="d-flex date-input-row">
                        <div className="start-date-div">
                            ...
                            <Form.Item
                                validateStatus={
                                    errorsFound.includes("eventStartDateTime")
                                        ? "error"
                                        : ""
                                }
                            >
                        ...
                        <div>
                            ...
                            <Form.Item
                                validateStatus={
                                    errorsFound.includes("eventEndDateTime")
                                        ? "error"
                                        : ""
                                }
                            >
                                <DatePicker
                                    ...
                                    value={
                                        eventEndDateTime &&
                                        dayjs(eventEndDateTime, "DD-MM-YYYY")
                                    }
                                    disabled={
                                        loading || eventStartDateTime === null
                                    }
                                    format="DD-MM-YYYY"
                    ...
                    {eventType == "online" ? (
                        <div>
                            ...
                            <Form.Item
                                validateStatus={
                                    errorsFound.includes("eventJoiningLink")
                                        ? "error"
                                        : ""
                                }
                            >
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setEventJoiningLink(e.target.value)
                                    }
                                    disabled={loading}
                                />
                            </Form.Item>
                        ...
                        <div>
                            ...
                            <Form.Item
                                validateStatus={
                                    errorsFound.includes("eventLocation")
                                        ? "error"
                                        : ""
                                }
                            >
