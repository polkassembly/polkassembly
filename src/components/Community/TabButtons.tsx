	...
	return (
		<article className='flex items-center justify-start gap-x-3'>
			...
			>
				...
				/>
				Delegates
				<span className={`m-0 p-0 text-xs font-normal ${selectedTab === ECommunityTabs.DELEGATES ? 'text-bodyBlue dark:text-white' : 'text-lightBlue dark:text-blue-dark-medium'}`}>
					({totalDelegates})
				</span>
			</Button>
			<Button
