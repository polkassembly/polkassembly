...
const TreasuryProposalFormButton = ({
	...
	const triggerBtn = (
		<button
			disabled={!id}
			className='-mt-1 flex cursor-pointer items-center justify-center  whitespace-pre rounded-[4px] border-none bg-pink_primary p-3 font-medium leading-[20px] tracking-[0.01em] text-white shadow-[0px_6px_18px_rgba(0,0,0,0.06)] outline-none'
						...
						<Form className='identity-form'>
							<div>
								...
								<div className=' mb-[1.5em]'>
									<label className='mb-3 flex items-center text-sm font-bold text-sidebarBlue'>
										Submit with account
										<HelperTooltip
											className='ml-2'
									...
									<div className=' flex items-center'>
										...
										<Form.Item
											...
											validateStatus={errorsFound.includes('submitWithAccount') ? 'error' : ''}
										>
								...
								<>
									<div className='mb-[1.5em]'>
										...
										<div className=' flex items-center'>
											...
											<Form.Item
												className=' mb-0 w-full'
												validateStatus={errorsFound.includes('beneficiaryAccount') ? 'error' : ''}
											>
										...
										{!extensionNotAvailable && (
											<div className=' mb-[1em] flex justify-between'>
												<div
													onClick={() => handleDetect(AvailableAccountsInput.beneficiary)}
													className=' ml-[1.5em] mt-[0.25em] cursor-pointer text-pink_primary'
												>
													or choose from available addresses
								...
								{/* Value */}
								<div className='mb-[1.5em] flex items-center'>
									<BalanceInput
										label={'Value'}
								...
								<p>
									<WarningFilled /> Be aware that once submitted the proposal will be put to a council vote. If the proposal is rejected due to a lack of info, invalid requirements
									or non-benefit to the network as a whole, the full bond posted (as describe above) will be lost.
								</p>
							</div>
