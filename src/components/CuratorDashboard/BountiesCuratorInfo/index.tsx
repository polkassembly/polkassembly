...
function BountiesCuratorInfo() {
	...
	return (
		<div className={`${spaceGrotesk.className} ${spaceGrotesk.variable} rounded-lg border-[0.7px] border-solid bg-white p-5`}>
			<p className='text-[24px] font-bold text-blue-light-high'>Bounties Curated ({curatedBounties.length})</p>
