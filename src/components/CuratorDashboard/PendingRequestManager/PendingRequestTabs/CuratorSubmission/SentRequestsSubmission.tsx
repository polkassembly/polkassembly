...
import { CheckCircleOutlined, DownOutlined, EditOutlined, UpOutlined } from '@ant-design/icons';
...
function SentSubmissions({ isloading, sentSubmissions }: { isloading: boolean; sentSubmissions: any }) {
	...
	const groupedBounties = groupBountyData(sentSubmissions);
											...
											{requests.map((request, index) => (
												...
												>
													...
													<div className='flex justify-between gap-4 p-2 px-4'>
														<span
															onClick={() => message.success('Request deleted successfully')}
