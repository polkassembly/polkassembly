...
const ActiveProposalCard = ({ proposal, trackDetails, status, delegatedTo }: Props) => {
	...
	return (
		<Link href={`/referenda/${proposal?.post_id}`}>
			<div
				className={
					'rounded-[6px] rounded-t-[6px] border-[1px] border-solid border-section-light-container hover:border-pink_primary dark:border-[#3B444F] dark:border-separatorDark'
				}
			>
