				...
				return (
					<div className='flex items-center justify-start gap-2 font-medium tracking-wider text-bodyBlue dark:text-white max-md:flex-col'>
						{status.map((item: ETrackDelegationStatus, index: number) => (
							<h2
								key={index}
								className={`text-[12px] ${item === ETrackDelegationStatus.Received_Delegation && 'bg-[#E7DCFF]'} ${
				...
				render: (action) => (
					<div className='flex items-start justify-center'>
						<Button
							...
							className='flex h-[40px] items-center justify-center gap-2 border-[1px] border-solid border-pink_primary px-2 text-sm font-normal text-bodyBlue dark:bg-transparent dark:text-white max-md:h-auto max-md:flex-col max-md:gap-0 max-md:border-none max-md:p-2 max-md:shadow-none'
						>
