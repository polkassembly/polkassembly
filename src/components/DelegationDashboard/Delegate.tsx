		...
		>
			...
			{expandProposals && (
				<div className="mt-[24px]">
					...
					>
            Enter an address or Select from the list below to delegate your
            voting power
					</h4>
                  ...
                  disabled
							...
							>
								...
								<span className="text-white text-sm font-medium">Delegate</span>
							</Button>
						</div>
						{/* <Popover
					showArrow={false}
            ...
            delegationDashboardAddress && (
              ...
              You cannot delegate to your own address. Please enter a different
              wallet address.
						</label>
					)}
              ...
              Web3.utils.isAddress(address)
                ...
                Invalid Address.
                    ...
                    'F1wAMxpzvjWCpsnbUMamgKfqFM7LRvNdkcQ44STkeVbemEZ'
								...
								.sort(
									(a, b) =>
										b.active_delegation_count - a.active_delegation_count
								)
								.map((delegate, index) => (
									<DelegateCard
										trackNum={trackDetails?.trackId}
