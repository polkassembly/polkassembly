...
const DelegateCard = ({ delegate, className, trackNum, disabled }: Props) => {
	...
	return <div className={`border-solid border-[1px] border-[#D2D8E0] rounded-[6px]  ${delegate?.dataSource === 'nova' ? 'hover:border-[#3C74E1]' : 'hover:border-pink_primary'} ${className}`}>
		...
		<div className='border-solid flex min-h-[92px] justify-between border-0 border-t-[1px]  border-[#D2D8E0] '>
			...
			<div className='pt-4 flex items-center flex-col border-solid w-[33%] border-0 border-x-[1px] border-[#D2D8E0] text-bodyBlue text-[20px] font-semibold'>
			...
			<div className='pt-4 flex items-center flex-col w-[33%] text-bodyBlue text-[20px] font-semibold'>
		...
		>
			<div className={'pt-[20px]'}>
				<div className='flex justify-between items-center pt-2 pl-8'>
					<div className='flex gap-2 max-lg:justify-start'>
						<Address address={delegate?.address} displayInline identiconSize={40} textClassName='text-[20px] font-medium'/>
				...
				<div className='border-solid flex min-h-[100px] justify-between border-0 border-t-[1px]  border-[#D2D8E0] '>
					<div className='pt-4 flex items-center flex-col w-[33%] text-[20px] font-semibold text-bodyBlue'>
						<div className='flex gap-x-1 items-center justify-center'>
							{formatedBalance(balance, unit)}
							<span className='text-sm font-normal mt-1 text-bodyBlue'>{unit}</span>
						</div>
						<div className='text-xs font-normal mt-[4px] text-[#576D8B]'>Voting power</div>
					</div>
					<div className='pt-4 flex items-center flex-col border-solid w-[33%] border-0 border-x-[1px] border-[#D2D8E0] text-bodyBlue text-[20px] font-semibold'>
