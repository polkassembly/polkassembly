...
const DelegationDashboardHome = ({ className } : Props) => {
	...
	return <div className= { `${ className } delegation-dashboard` }>
		...
		{!openLoginModal && !openSignupModal && !userDetails.loginWallet && <WalletConnectModal localStorageWalletKeyName='delegationWallet' localStorageAddressKeyName='delegationDashboardAddress' open={openModal} setOpen={setOpenModal} />}
