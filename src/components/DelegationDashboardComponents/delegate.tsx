...
const Delegate = ( { className }: Props ) => {
		...
		{expandProposals && <div className=' h-[100px] mt-[24px]'>
			...
			<div className='flex gap-4 items-center'>
				<div className='text-[#576D8BCC] font-normal text-[14px] h-[48px] border-[1px] border-solid border-[#D2D8E0] rounded-md flex items-center justify-between w-[93%] max-lg:w-[85%]'>
					<Input type='text' placeholder='Enter address to Delegate vote' className='border-0' />
					<Button className='h-[40px] py-1 px-4 flex justify-around items-center rounded-md bg-pink_primary gap-2 mr-1'>
