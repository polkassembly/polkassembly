...
const columns: ColumnsType<IPostsRowData> = [
	...
	},
	{
		...
		dataIndex: 'username',
		key: 'postedBy',
		render: (username, { proposer }) => <div className='truncate' ><NameLabel textClassName='max-w-[9vw] 2xl:max-w-[12vw] text-[#243a57] font-semibold' defaultAddress={proposer} username={username} disableIdenticon={false} /></div>,
		width: 200
	},
	{
		title: 'Created',
