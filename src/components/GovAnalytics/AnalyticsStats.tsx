			...
			<div className='mr-2.5 mt-2 flex items-center justify-between max-sm:flex-col lg:max-w-[100%]'>
				<div className='flex items-center space-x-2 max-sm:w-full max-sm:justify-start'>
					...
					<div className='flex flex-col'>
						<span className='text-xs font-normal text-blue-light-medium dark:text-blue-dark-medium'>{t('total_proposals')}</span>
				...
				<div className='flex items-center space-x-2 max-sm:w-full max-sm:justify-start'>
					<div className='flex h-[70px] w-[70px] items-center justify-center rounded-full bg-[#CCF3FF]'>
						<ImageIcon
							...
							alt={t('approved_proposal_icon')}
							className='-mt-0.5 ml-1'
						/>
					</div>
					<div className='flex flex-col'>
						<span className='text-xs font-normal text-blue-light-medium dark:text-blue-dark-medium'>{t('approved_proposals')}</span>
				...
				<div className='flex items-center space-x-2 max-sm:w-full max-sm:justify-start'>
					<ImageIcon
						...
						alt={t('monitored_tracks_icon')}
						className=''
					/>
					<div className='flex flex-col'>
						<span className='text-xs font-normal text-blue-light-medium dark:text-blue-dark-medium'>{t('monitored_tracks')}</span>
