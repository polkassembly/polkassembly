            ...
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            {
              ...
              if (burn) {
                ...
                if (
                  ...
                  valueUSD = formatUSDWithUnits(
                    (
                      nextBurnValueUSD * Number(currentTokenPrice.value)
                    ).toString(),
                  );
                }
            ...
            }
            {
              ...
              if (freeBalance) {
                ...
                if (
                  ...
                  valueUSD = formatUSDWithUnits(
                    (
                      availableValueUSD * Number(currentTokenPrice.value)
                    ).toString(),
                  );
                }
                value = formatUSDWithUnits(
    ...
    async function fetchWeekAgoTokenPrice() {
      ...
      try {
        ...
        if (responseJSON['message'] == 'Success') {
          ...
          const percentChange =
            ((currentTokenPriceNum - weekAgoPriceNum) / weekAgoPriceNum) * 100;
          setPriceWeeklyChange({
            isLoading: false,
  ...
  return (
    <div
      className={`${className} grid ${
        !['polymesh', 'polymesh-test'].includes(network) && 'grid-rows-2'
      } grid-cols-2 grid-flow-col xs:gap-6 sm:gap-8 xl:flex`}
    >
      {/* Available */}
                      ...
                      <>
                        ...
                        <div className="flex items-center">
                          ...
                          {Number(priceWeeklyChange.value) < 0 ? (
                            <CaretDownOutlined
                              style={{ color: 'red', marginLeft: '1.5px' }}
                            />
                          ) : (
                            <CaretUpOutlined
                              style={{ color: '#52C41A', marginLeft: '1.5px' }}
                            />
                          )}
                        </div>
                      </>
                      ...
                      <div className="text-bodyBlue flex whitespace-pre font-medium items-baseline mt-1 sm:mt-0">
                        {spendPeriod.value?.total ? (
                          <>
                            ...
                            <span className="text-lightBlue text-[10px] sm:text-xs">
                      ...
                      <div className="flex flex-col justify-center font-medium gap-y-3">
                        ...
                        <span className="flex items-center">
                          <Progress
                            ...
                            percent={
                              !isNaN(Number(spendPeriod.percentage))
