...
const OffChainPostsContainer: FC<IOffChainContainerProps> = ({
	posts,
	className,
	count,
	proposalType
	...
	return (
		<div
			className={`${className} bg-white xs:py-3 xs:px-0 md:p-0 rounded-[14px] shadow-[0px_6px_18px_rgba(0,0,0,0.06)]`}
		>
