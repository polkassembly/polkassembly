		...
		<div className='flex justify-center items-center flex-col -mt-[132px]'>
			...
			{isDelegate && <div className='flex flex-col justify-center items-center gap-[14px]'>
				...
				<div className='flex-col flex items-start justify-center gap-[10px]'>
					{address && <div className='flex gap-3 text-sm text-bodyBlue font-normal'>{isVote ? 'With' : 'To'} address:<span className='font-medium'>
					...
					<div className='flex gap-[30px] text-sm text-bodyBlue font-normal'> Conviction:<span className='text-[#243A57] font-medium'>{conviction}x</span> </div>
