        ...
        >
            <div className="flex flex-col gap-y-1">
                ...
                <p className="text-sidebarBlue">
                    Please open the two-step verification app or extension and
                    input the authentication code for your Polkassembly account.
                </p>
                ...
                <Form.Item
                    ...
                    rules={[
                        {
                            message:
                                "Please provide a valid authentication code.",
