		...
		<div className={className}>
			...
			>
				...
				<div className='flex w-full items-end gap-2 text-sm '>
					<div className='dark:border-separatorDark flex h-[40px] w-full items-center justify-between rounded-[4px] border-[1px] border-solid border-[#D2D8E0] bg-[#f5f5f5] px-2'>
						<Address
							address={address}
				...
				<div>
					...
					<div className='mt-1 flex items-center  '>
						<span className='mb-6 flex w-[150px] items-center gap-2'>
							<EmailIcon className='dark:bg-inactiveIconDark dark:text-blue-dark-medium rounded-full bg-[#edeff3] p-2.5 text-xl text-[#576D8B]' />
					...
					<div className='mt-1 flex items-center'>
						<span className='mb-6 flex w-[150px] items-center gap-2'>
							<TwitterIcon className='dark:bg-inactiveIconDark dark:text-blue-dark-medium rounded-full bg-[#edeff3] p-2.5 text-xl text-[#576D8B]' />
							<span className='text-sm text-lightBlue'>
			...
			{!alreadyVerifiedfields?.alreadyVerified && !alreadyVerifiedfields.isIdentitySet && (
				<div className='mt-6 flex items-center gap-4 text-sm'>
					...
					<span className='dark:bg-inactiveIconDark rounded-2xl bg-[#EDEFF3] px-3 py-1 font-medium text-bodyBlue'>
