		...
		<div className={className}>
			{!isIdentityAlreadySet && showAlert && !alreadyVerifiedfields.email && !alreadyVerifiedfields.twitter && (
				<Alert
					showIcon
					type='info'
					className='mt-4 h-10 rounded-[4px] text-[13px] text-bodyBlue dark:border-[#91CAFF] dark:bg-[rgba(145_202_255_0.2)]'
			...
			{isIdentityAlreadySet && showAlert && (!alreadyVerifiedfields.email || !alreadyVerifiedfields.twitter) && (
				<Alert
					showIcon
					type='info'
					className='mt-4 rounded-[4px] text-[13px] text-bodyBlue dark:border-[#91CAFF] dark:bg-[rgba(145_202_255_0.2)]'
					description={
