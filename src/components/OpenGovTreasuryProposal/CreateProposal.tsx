		...
		>
			<div className={`create-proposal ${className}`}>
				{submitionDeposite.gte(availableBalance) && !txFee.eq(ZERO_BN) && (
					<Alert
						type='error'
						className={`text-blue-light-high dark:text-blue-dark-high mt-6 rounded-[4px] ${poppins.variable} ${poppins.className}`}
						showIcon
				...
				<Alert
					...
					className={`text-blue-light-high dark:text-blue-dark-high mt-4 rounded-[4px] text-sm ${poppins.variable} ${poppins.className}`}
					type='success'
					showIcon
				/>
				<div className='dark:text-blue-dark-high mt-4 text-sm font-normal text-lightBlue dark:font-normal'>
					<div className='mt-4 flex flex-col gap-2'>
						<span className='flex'>
							...
							<Address
								...
								iconSize={18}
								displayInline
								usernameClassName='text-blue-light-high dark:text-blue-dark-high'
						...
						<span className='flex'>
							...
							<Address
								addressClassName='text-blue-light-high dark:text-blue-dark-high'
						...
						<span className='flex'>
							...
							<span className='font-medium text-bodyBlue'>
								{selectedTrack} <span className='text-blue-light-high dark:text-blue-dark-high font-medium'>#{networkTrackInfo[network][selectedTrack]?.trackId || 0}</span>
							</span>
						</span>
						<span className='flex'>
						...
						<span className='flex items-center'>
							...
							<a
								...
								className='text-blue-light-high dark:text-blue-dark-high font-medium'
				...
				{showAlert && (
					<Alert
						className='text-blue-light-high dark:text-blue-dark-high mt-6 rounded-[4px]'
						showIcon
						type='info'
						message={
							<span className='text-blue-light-high dark:text-blue-dark-high text-sm'>
								An amount of{' '}
				...
				<div className='dark:border-separatorDark -mx-6 mt-6 flex justify-end gap-4 border-0 border-t-[1px] border-solid border-[#D2D8E0] px-6 pt-4'>
					<Button
