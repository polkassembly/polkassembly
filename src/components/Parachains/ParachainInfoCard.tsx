	...
	return (
		<div className={className}>
			<div className='rounded-xxl bg-white p-3 drop-shadow-md dark:bg-section-dark-overlay lg:p-6'>
				...
				<div className='parachain-card-meta text-bodyBlue opacity-90 dark:text-blue-dark-high'>
					...
					<div className='metric-container'>
						<div className='metric-line flex items-center'>
							<Image
								...
								alt='Auction Icon'
							/>
							<span className='metric-num ml-[7px] text-xs font-medium text-bodyBlue dark:text-blue-dark-high md:text-base'>{metrics.auction}</span>
						</div>
					...
					<div className='metric-container'>
						<div className='metric-line flex items-center'>
							<Image
								...
								alt='Crowdloans Icon'
							/>
							<span className='metric-num ml-[7px] text-xs font-medium text-bodyBlue dark:text-blue-dark-high md:text-sm'>{metrics.crowdloans}</span>
						</div>
					...
					<div className='metric-container'>
						<div className='metric-line flex items-center'>
							<Image
								...
								alt='Parachains Icon'
							/>
							<span className='metric-num ml-[7px] text-xs font-medium text-bodyBlue dark:text-blue-dark-high md:text-sm'>{metrics.parachains}</span>
						</div>
					...
					<div className='metric-container'>
						<div className='metric-line flex items-center'>
							<Image
								...
								alt='Parachains Icon'
							/>
							<span className='metric-num ml-[7px] text-xs font-medium text-bodyBlue dark:text-blue-dark-high md:text-sm'>{metrics.projects}</span>
						</div>
