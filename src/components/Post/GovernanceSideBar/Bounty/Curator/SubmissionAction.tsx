...
import { EChildbountySubmissionStatus, EUserCreatedBountySubmissionStatus, IChildBountySubmission } from '~src/types';
...
const StatusUI = ({ status }: { status: EChildbountySubmissionStatus | EUserCreatedBountySubmissionStatus }) => {
	return (
		<div
