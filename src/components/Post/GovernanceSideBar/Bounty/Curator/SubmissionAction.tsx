	...
	return (
		<div className='flex w-full'>
			{submission?.proposer === encodedAddress && submission.status === EChildbountySubmissionStatus.PENDING ? (
				...
				submission.status === EChildbountySubmissionStatus.PENDING && (
			...
			{submission.status === EChildbountySubmissionStatus.APPROVED ? (
				...
				submission.status === EChildbountySubmissionStatus.REJECTED && (
