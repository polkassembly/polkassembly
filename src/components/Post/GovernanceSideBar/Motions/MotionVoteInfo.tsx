...
const MotionVoteInfo: FC<IMotionVoteInfoProps> = (props) => {
	...
	return (
		<GovSidebarCard className={`${className} px-1 md:px-9`}>
			<h3 className='dashboard-heading flex items-center'>{props.title} Votes <HelperTooltip className='ml-2' text='This represents the onchain votes of council members'/></h3>
			<div className='mt-6'>
