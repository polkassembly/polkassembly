...
const VoteMotion = ({
    ...
    const VotingForm = () => (
        <GovSidebarCard>
            <h3 className="text-[#243A57] font-semibold text-xl leading-6 tracking-[0.0015em] mb-6">
                Cast your Vote!
            </h3>
            <Button
            ...
            >
                ...
                >
                    <h4 className="text-[#243A57] font-semibold text-xl leading-6 tracking-[0.0015em] mb-7">
                        Cast Your Vote
                    </h4>
    ...
    const NotCouncil = () => (
        <GovSidebarCard>
            ...
            />
            <Button onClick={() => setForceVote(true)}>
                Let me try still.
            </Button>
        </GovSidebarCard>
    );
    ...
    return (
        <div className={className}>
            {isCouncil || forceVote ? <VotingForm /> : <NotCouncil />}
        </div>
    );
};
