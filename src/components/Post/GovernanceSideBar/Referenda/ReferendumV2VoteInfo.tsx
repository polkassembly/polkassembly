		...
		<>
			<GovSidebarCard className={className}>
				<div className='relative z-50 flex items-center justify-between'>
					<h6 className='m-0 p-0 text-xl font-medium leading-6 text-bodyBlue dark:text-white'>Summary</h6>
				...
				>
					...
					<Modal
						...
						title={
							<label className={`${poppins.variable} ${poppins.className} text-xl font-semibold leading-[30px] tracking-[0.01em] text-bodyBlue dark:text-white`}>
					...
					>
						<section className='flex flex-col gap-y-6'>
							...
							>
								<p className='m-0 mt-5 p-0 px-6 text-sm font-normal leading-[18px] text-bodyBlue dark:text-white'>
							...
							<article className='my-2 flex items-center justify-between md:gap-x-2'>
								<div className='flex flex-col items-center justify-center gap-y-3'>
									...
									<p className='m-0 flex flex-col items-center p-0 text-xs font-normal leading-4 text-bodyBlue dark:text-white'>
								...
								<div className='flex flex-col items-center justify-center gap-y-3'>
									...
									<p className='m-0 hidden flex-col items-center p-0 text-xs font-normal leading-4 text-bodyBlue dark:text-white md:flex'>
										<span className='whitespace-nowrap'>Chooses vote amount</span>
										<span>and type (Aye/Nay)</span>
									</p>
									<p className='m-0 flex flex-col items-center p-0 text-xs font-normal leading-4 text-bodyBlue dark:text-white md:hidden'>
							...
							<div className='flex flex-col'>
								<div style={{ borderTop: '1.5px dashed #D2D8E0' }}>
									<p className='m-0 mt-5 p-0 text-sm font-medium leading-[18px] text-bodyBlue dark:text-white'>Here,</p>
								</div>
								<article
								...
								>
									<div className='flex flex-col items-center justify-center'>
										<p className='m-0 mt-[2px] flex flex-col p-0 text-sm font-normal text-bodyBlue dark:text-white'>
									...
									<div className='flex flex-col items-center justify-center '>
										<p className='m-0 flex flex-col p-0 text-sm font-normal text-bodyBlue dark:text-white'>
