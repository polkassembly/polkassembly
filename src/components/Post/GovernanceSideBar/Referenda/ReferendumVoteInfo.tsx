              ...
              if (vote) {
                ...
                if (decision === 'yes') {
                  voteInfo.aye_without_conviction =
                    voteInfo.aye_without_conviction.add(new BN(balance.value));
                  if (lockPeriod === 0) {
                    voteInfo.aye_amount = voteInfo.aye_amount.add(
                      new BN(balance.value).div(new BN(10)),
                    );
                  } else {
                    voteInfo.aye_amount = voteInfo.aye_amount.add(
                      new BN(balance.value).mul(new BN(lockPeriod)),
                    );
                  }
                } else {
                  voteInfo.nay_without_conviction =
                    voteInfo.nay_without_conviction.add(new BN(balance.value));
                  if (lockPeriod === 0) {
                    voteInfo.nay_amount = voteInfo.nay_amount.add(
                      new BN(balance.value).div(new BN(10)),
                    );
                  } else {
                    voteInfo.nay_amount = voteInfo.nay_amount.add(
            ...
            if (voteThreshold) {
              ...
              if (totalIssuance !== null) {
                ...
                capitalizedVoteThreshold = `${capitalizedVoteThreshold
                  .charAt(0)
                  .toUpperCase()}${capitalizedVoteThreshold.slice(1)}`;
          ...
          <GovSidebarCard>
            ...
            >
              <div className="flex items-center justify-between gap-x-2">
                <h6 className="text-bodyBlue font-medium text-xl leading-[24px] m-0 p-0">
                  Voting
                </h6>
                <div className="flex items-center justify-center gap-x-2">
                  <div
                    className={
                      'text-bodyBlue border-solid border-bodyBlue border xl:max-w-[120px] 2xl:max-w-[100%] text-xs rounded-full px-3 py-1 whitespace-nowrap truncate h-min'
                    }
                  >
                    {voteInfo?.voteThreshold}
                  </div>
                  {voteInfo.isPassing !== null && (
              ...
              <section className="grid grid-cols-2 gap-x-7 gap-y-3 text-lightBlue -mt-4">
                <article className="flex items-center justify-between gap-x-2">
                  ...
                  <div className="text-lightBlue text-xs font-medium leading-[22px]">
                    {formatUSDWithUnits(
                      formatBnBalance(
                        voteInfo?.aye_amount,
                        {
              ...
              <div className="flex items-center justify-between gap-x-2">
                ...
                <div className="flex items-center justify-center gap-x-2 relative z-50">
                  <div
                    ...
                    className={
                      'text-bodyBlue border-solid border-navBlue border xl:max-w-[120px] 2xl:max-w-[100%] text-xs rounded-full px-3 py-1 whitespace-nowrap truncate h-min'
                    }
                  >
                    {voteInfo?.voteThreshold}
                  </div>
