							...
							<>
									...
									>
										...
										<div className='ml-[-24px] mr-[-24px] mt-[-3px] flex justify-end border-0 border-t-[1px] border-solid border-[#D2D8E0] pt-5'>
											...
											<Button
												...
												htmlType='submit'
												disabled={!wallet || !lockedBalance || (showMultisig && !multisig) || (showMultisig && initiatorBalance.lte(totalDeposit))}
											>
												Confirm
											</Button>
										</div>
								...
								{proposalType !== ProposalType.FELLOWSHIP_REFERENDUMS && vote === EVoteDecisionType.SPLIT && (
									...
									>
										...
										<div className='ml-[-24px] mr-[-24px] mt-[-1px] flex justify-end border-0 border-t-[1px] border-solid border-[#D2D8E0] pt-5'>
											<Button
												className='mr-[15px] h-[40px] w-[134px] rounded-[4px] border-[#E5007A] bg-[white] font-semibold text-[#E5007A]'
												onClick={() => setShowModal(false)}
											>
											...
											<Button
												className={`mr-[24px] h-[40px] w-[134px] rounded-[4px] border-0 bg-[#E5007A] font-semibold text-[white] ${(!wallet || !lockedBalance) && 'opacity-50'}`}
												htmlType='submit'
												disabled={!wallet || !lockedBalance || (showMultisig && !multisig)}
											>
												Confirm
											</Button>
										</div>
