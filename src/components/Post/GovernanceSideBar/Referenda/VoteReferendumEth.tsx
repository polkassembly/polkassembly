			...
			>
				<>
					...
					>
						...
						<Segmented
							block
							className={'dark:bg-section-dark-overlay dark:border-separatorDark mb-6 w-full rounded-[4px] border-[1px] border-solid border-[#D2D8E0] bg-white hover:bg-white'}
							size='large'
							value={vote}
							onChange={(value) => {
