...
const VoteReferendumEthV2 = ({
  ...
  useEffect(() => {
    if (
      userDetails.loginWallet &&
      [Wallet.TALISMAN, Wallet.METAMASK].includes(userDetails.loginWallet)
    ) {
  ...
  const getAccounts = async (wallet: Wallet) => {
    ...
    wallet === Wallet.TALISMAN &&
    addresses.filter((address: string) => address.slice(0, 2) === '0x')
      .length === 0
      ? setIsTalismanEthereum(false)
      : setIsTalismanEthereum(true);
  ...
  return (
    <div className={className}>
      ...
      <Modal
        ...
        title={
          <div className="h-[65px] -mt-5 border-0 border-solid border-b-[1.2px] border-[#D2D8E0] mr-[-24px] ml-[-24px] rounded-t-[6px] flex items-center justify-center gap-2">
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center gap-x-5 mt-1 mb-[24px] justify-center">
              {availableWallets[Wallet.TALISMAN] && (
                <WalletButton
                  ...
                  name="Talisman"
                  icon={
                    <WalletIcon which={Wallet.TALISMAN} className="h-6 w-6" />
                  }
                />
              )}
              {isMetamaskWallet && (
                <WalletButton
                  ...
                  name="MetaMask"
                  icon={
                    <WalletIcon which={Wallet.METAMASK} className="h-6 w-6" />
                  }
                />
              )}
            </div>
            ...
            {accounts.length > 0 ? (
              ...
              <Alert type="info" message="Please select a wallet." showIcon />
            ) : null}
