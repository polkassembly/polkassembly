...
const ArgumentsTableJSONView = dynamic(
        ...
        <OnchainInfoWrapper>
          ...
          <ul className="list-none flex flex-col gap-y-2">
            {proposer ? (
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                <h6 className="col-span-2 text-lightBlue font-medium">
                  Proposer
                </h6>
            ...
            {origin && (
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                <h6 className="text-lightBlue font-medium col-span-2">
                  Origin
                </h6>
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6 overflow-hidden">
              ...
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                ...
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6 overflow-hidden">
                  {String(enactment_after_block).length < 8 ? (
                    ...
                    <div>
                      <span>
                        {formattedBlockToTime(Number(enactment_after_block))}
                      </span>
                      <a
              ...
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-b py-1.5">
                ...
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6 overflow-hidden">
                  {String(enactment_at_block).length < 8 ? (
                    ...
                    <div>
                      <span>
                        {formattedBlockToTime(Number(enactment_at_block))}
                      </span>
                      <a
              ...
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                ...
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6 overflow-hidden">
                  {`${deciding.since}`.length < 8 ? (
                    ...
                    <div>
                      <span>
                        {formattedBlockToTime(Number(deciding.since))}
                      </span>
                      <a
              ...
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                ...
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6 overflow-hidden">
                  {`${deciding.confirming}`.length < 8 ? (
                    ...
                    <div>
                      <span>
                        {formattedBlockToTime(Number(deciding.confirming))}
                      </span>
                      <a
            ...
            {ended_at_block && ended_at && (
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b pb-1.5">
                {status === tipStatus.CLOSING ? (
                  <>
                    <h6 className="text-lightBlue font-medium col-span-2 pt-1.5">
                      Closing
                    </h6>
            ...
            {deposit && network && (
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                <h6 className="text-lightBlue font-medium col-span-2 text-base">
                  Deposit
                </h6>
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6">
                  {(typeof deposit === 'string' ? parseInt(deposit) : deposit) /
                    Math.pow(10, chainProperties[network]?.tokenDecimals) +
                    ' ' +
            ...
            {hash && (
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                <h6 className="text-lightBlue font-medium col-span-2 flex items-center text-base">
                  Proposal Hash
                </h6>
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6">
                  {hash}
            ...
            {reward && (
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                ...
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6">
                  {(typeof reward === 'string' ? parseInt(reward) : reward) /
                    Math.pow(10, chainProperties[network]?.tokenDecimals) +
                    ' ' +
                    chainProperties[network]?.tokenSymbol}
                </div>
            ...
            {fee && (
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                ...
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6">
                  {(typeof fee === 'string' ? parseInt(fee) : fee) /
                    Math.pow(10, chainProperties[network]?.tokenDecimals) +
                    ' ' +
                    chainProperties[network]?.tokenSymbol}
                </div>
            ...
            {curator_deposit && (
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                ...
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6">
                  {(typeof curator_deposit === 'string'
                    ? parseInt(curator_deposit)
                    : curator_deposit) /
                    Math.pow(10, chainProperties[network]?.tokenDecimals) +
                    ' ' +
                    chainProperties[network]?.tokenSymbol}
            ...
            {bond && (
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                ...
                <div className="text-bodyBlue font-medium col-span-4 md:col-span-6">
                  {(typeof bond === 'string' ? parseInt(bond) : bond) /
                    Math.pow(10, chainProperties[network]?.tokenDecimals) +
                    ' ' +
                    chainProperties[network]?.tokenSymbol}
                </div>
              ...
              <li className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b py-1.5">
                ...
                <div
                  className={`col-span-4 md:col-span-6 ${
                    motion_method === 'reject_proposal'
                      ? 'bold-red-text'
                      : 'text-bodyBlue font-medium'
                  }`}
                >
                  {motion_method}
                </div>
            ...
            <div className="mt-7">
              ...
              {proposal_arguments?.description ? (
                <div className="grid grid-cols-6 md:grid-cols-8 gap-x-5 border-0 border-[#e5e7eb] border-solid border-b mt-5">
                  <h6 className="text-lightBlue font-medium col-span-6 md:col-span-2 text-base">
                    Description
                  </h6>
                  <p className="text-bodyBlue font-medium leading-6 col-span-6">
                    {proposal_arguments?.description}
                  </p>
                </div>
              ) : null}
          ...
          {proposed_call ? (
            <div className="mt-5 flex flex-col gap-y-5">
              <ProposalInfo method={method} proposed_call={proposed_call} />
            </div>
          ) : null}
          {description ? (
    ...
    <>
      {proposed_call?.method !== method && (
        <div className="grid grid-cols-6 md:grid-cols-8 border-0 border-[#e5e7eb] border-solid border-b gap-x-5">
          <h6 className="text-lightBlue font-medium col-span-6 md:col-span-2">
            Method
          </h6>
          <p className="text-bodyBlue font-medium leading-6 col-span-6">
            {proposed_call.method}
          </p>
        </div>
      )}
