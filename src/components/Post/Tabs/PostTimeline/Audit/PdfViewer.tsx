...
const PdfViewer: FC<IPdfViewerProps> = (props) => {
	...
	return (
		<>
			<button
				className={`flex items-center justify-center overflow-hidden rounded-[6px] border border-solid border-section-light-container bg-transparent outline-none dark:border-[#3B444F] ${className}`}
