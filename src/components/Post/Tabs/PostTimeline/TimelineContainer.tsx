        ...
        return (
            <section
                className={`flex-1 flex ${
                    isMobile
                        ? "flex-col items-start gap-y-20 py-20"
                        : "items-center"
                }`}
            >
                {statuses
                    .sort(sortfunc)
                    .map(({ block, status, timestamp }, index) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`flex-1 h-[1px] bg-navBlue ${
                                        !isMobile
                                            ? index === 0
                                                ? "min-w-[50px]"
                                                : "min-w-[25px]"
    ...
    return (
        <section className="flex">
            <div className="min-h-[300px] bg-pink_primary w-[2px] relative">
                ...
                <span className="bg-pink_primary rounded-full absolute -bottom-1 -left-1 w-[10px] h-[10px]"></span>
            </div>
