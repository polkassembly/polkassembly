      ...
      || (filterBy ===  EFilterBy.People && peopleResultsCounts === 0 )
		? <div className='flex flex-col justify-center items-center mt-7 mb-5'>
			<div className='text-bodyBlue text-sm font-medium tracking-[0.01em]'>
				<div className='flex flex-col mt-5 justify-center items-center'>
					<EmptyResultsIcon/>
					<span className='text-sm font-medium text-bodyBlue mt-8 tracking-[0.01em]'>{!isSearchErr ? 'No search results found. You may want to try using different keywords.' : 'Please enter at least 3 characters to proceed.'}</span>
				</div>
			</div>
		...
		:!isSuperSearch ?
			<div className='flex flex-col justify-center items-center mb-5'>
				<label className='text-sm font-medium text-bodyBlue mt-8 tracking-[0.01em]'>Didn’t find what you were looking for?</label>
