	...
	return (
		...
		>
			...
			<StyledAlert
				...
				message={
					`Are you sure you want to disable this Polkassemble bot, Disabling bot means no more notifications for ${channel} channel chat, Stay connected and informed by keeping the bot enabled.`
				}
			/>
