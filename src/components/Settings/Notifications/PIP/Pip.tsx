									...
									return (
										<React.Fragment key={postType.toString()}>
											<GroupCheckbox
												...
												classname={
													i === category.length - 1
														? 'md:border-dashed md:border-x-0 md:border-y-0 md:border-l-2 md:border-section-light-container dark:border-[#3B444F] md:pl-[48px] dark:border-separatorDark'
														: 'md:basis-[50%]'
												}
											...
											{i !== category.length - 1 && (
												<Divider
													className='border-[2px] border-section-light-container dark:border-[#3B444F] md:hidden'
													dashed
												/>
											)}
										</React.Fragment>
