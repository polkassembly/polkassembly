...
const Row = ({
	...
	<div className="flex justify-between items-baseline">
		<div>
			<label className="text-[#485F7D] text-[14px]" htmlFor={label}>
				{label}
			</label>
		...
		<span
			className="text-[14px] font-medium text-pink_primary cursor-pointer flex items-center gap-1 text-[#485F7D]"
			onClick={handleEdit}
		>
			<EditPencilIcon /> Edit
		</span>
