...
const TinderCardsComponent: FC<ITinderCardsComponent> = (props) => {
	...
	return (
		<section className='flex flex-col gap-y-4 overflow-x-hidden'>
			<div className='overflow-y-auto rounded-2xl bg-white p-4 px-4 py-6 drop-shadow-md dark:border dark:border-solid dark:border-[#D2D8E0] dark:bg-transparent'>
			...
			<div className='h-full w-full rounded-2xl bg-white p-4 px-4 py-6 shadow dark:border dark:border-solid dark:border-[#D2D8E0] dark:bg-transparent'>
