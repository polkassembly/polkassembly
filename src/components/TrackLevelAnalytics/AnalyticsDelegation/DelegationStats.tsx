			...
			{stats.map((stat, index) => (
				<React.Fragment key={index}>
					<div className='flex flex-col items-center rounded-xl bg-[#D2D8E04F] pb-1 pt-2 dark:bg-[#1F1F20] sm:bg-transparent dark:sm:bg-transparent'>
						...
						<div className=' text-center text-[28px] font-semibold text-blue-light-high dark:text-blue-dark-high'>
							{stat.value}
							<span className='ml-[2px] text-lg font-semibold text-blue-light-medium dark:text-blue-dark-medium'>{tokenSymbol}</span>
						</div>
					</div>
