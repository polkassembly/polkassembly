...
const About: FC<IAboutProps> = (props) => {
	...
	return (
		<div className={className}>
			...
			<Collapse
				className="bg-white m-0 p-0 border-none outline-none shadow-none content-border"
				...
				<Collapse.Panel
					...
					header={
						<p className="m-0 p-0 py-1 rounded-none flex items-center gap-x-2">
							...
							<span className="text-sidebarBlue font-semibold text-sm">
                Addresses
							</span>
						</p>
					}
              ...
              addresses.slice(0, 5).map((address) => {
              	return (
              		<Address
              			...
              			key={address}
              			className="text-sidebarBlue p-3 py-4 border-0 border-b border-solid border-b-[#E1E6EB]"
              			address={address}
              		/>
              	);
              })}
					...
					<div className="-m-4 flex flex-col rounded-[4px] bg-gray-50 py-4 px-2">
                        ...
                        Account
                          ...
                          Legal
												...
												<p className=" text-[#5E7087] text-sm font-normal mt-1">
													{identity.legal}
												</p>
											</Col>
										)}
										{identity?.email && (
											<Col span={12}>
												...
												<a
													...
													className="block text-[#5E7087] text-sm font-normal mt-1 truncate"
												>
													{identity.email}
												</a>
											</Col>
