...
const BasicInformation: FC<IBasicInformationProps> = (props) => {
    ...
    return (
        <div
            className={`flex flex-col justify-between max-h-[552px] overscroll-y-scroll ${className}`}
        >
            <article className="flex flex-col md:flex-row gap-x-6 items-center">
                ...
                <div className="flex flex-col">
                    <h4 className="text-sm text-[#485F7D] font-medium ">
                        Profile Image
                    </h4>
                    <p className="font-normal text-sm -mt-1">
                        Please provide a url of your profile photo using a
                        service such as
                        <a
            ...
            <div className="flex gap-x-6">
                ...
                <div className="flex-1">
                    ...
                    <article className="text-sm cursor-pointer mt-4 text-[#485F7D]">
                        <label className="text-sm text-[#485F7D] font-medium mb-0">
                            Username
                        </label>
                        <Input
                    ...
                    <article className="mt-4">
                        ...
                        <HelperTooltip
                            className="ml-1 cursor-pointer text-xs font-normal text-[#485F7D] m-0 mb-1 leading-[18px]"
                                ...
                                {profile?.badges.map((badge) => {
                                    return (
                                        <Tag
                                            closeIcon={
                                                <CloseOutlined
                                                    className={`m-0 p-0 flex text-white ${
                                                        loading
                                                            ? "cursor-not-allowed"
                                                            : ""
                                                    }`}
                                            ...
                                            className={`capitalize rounded-full inline-flex font-medium outline-none border-none shadow-none px-3 py-0.5 gap-x-1 items-center bg-pink_primary text-white m-0 mt-2 mr-2 ${
                                                loading
                                                    ? "cursor-not-allowed"
                                                    : ""
                                            }`}
