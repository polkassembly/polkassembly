...
const CardComments: FC<ICardComments> = (props) => {
	...
	return (
		<div className='mx-auto flex max-h-[304px] flex-col gap-y-4 overflow-y-auto overflow-x-hidden rounded-xl border border-solid border-[#D2D8E0] p-2 px-4 py-6'>
			...
			{proposal.comments.map((comment: any, index: number) => (
				...
				>
					...
					<div className='flex flex-col gap-y-2'>
						<p className='m-0 flex items-center justify-center p-0 text-xs text-bodyBlue dark:text-blue-dark-medium'>{comment.content}</p>
