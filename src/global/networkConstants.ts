...
export const chainProperties: types.ChainPropType = {
	[network.POLKADOT]: {
		...
		subscanAPI: 'https://polkadot.api.subscan.io'
	},
	[network.KUSAMA]: {
		blockTime: 6000,
		category: 'kusama',
		...
		subscanAPI: 'https://kusama.api.subscan.io'
	},
	[network.ACALA]:{
		blockTime: 12000,
		chainId: 0,
		...
		subscanAPI: 'https://acala.api.subscan.io'
	},
	[network.ACUITY]: {
		blockTime: 6000,
		category: 'solo',
		...
		subscanAPI: 'https://acuity.api.subscan.io'
	},
	[network.ALTAIR]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://altair.api.subscan.io'
	},
	[network.AMPLITUDE]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://amplitude.api.subscan.io'
	},
	[network.ASTAR]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://astar.api.subscan.io'
	},
	[network.AUTOMATA]: {
		blockTime: 6000,
		category: 'solo',
		...
		subscanAPI: 'https://automata.api.subscan.io'
	},
	[network.BASILISK]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://basilisk.api.subscan.io'
	},
	[network.PIONEER]: {
		blockTime: 12000,
		category: 'solo',
		...
		subscanAPI: 'https://pioneer.api.subscan.io'
	},
	[network.CALAMARI]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://calamari.api.subscan.io'
	},
	[network.CENTRIFUGE]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://centrifuge.api.subscan.io'
	},
	[network.COMPOSABLE]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://composable.api.subscan.io'
	},
	[network.CRUST]: {
		blockTime: 12000,
		category: 'solo',
	...
	[network.CRUSTSHADOW]: {
		...
		subscanAPI: 'https://crustshadow.api.subscan.io'
	},
	[network.EQUILIBRIUM]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://equilibrium.api.subscan.io'
	...
	[network.FREQUENCY]: {
		...
		subscanAPI: 'https://frequency.api.subscan.io'
	},
	[network.FREQUENCYROCOCO]: {
		...
		subscanAPI: 'https://api.frequency-rococo.subscan.io'
	},
	[network.GEAR]: {
		blockTime: 1000,
		category: 'solo',
		...
		subscanAPI: 'https://gear.api.subscan.io'
	},
	[network.GENSHIRO]: {
		blockTime: 6000,
		category: 'test',
		...
		subscanAPI: 'https://genshiro.api.subscan.io'
	},
	[network.GMORDIE]: {
		blockTime: 9000,
		category: 'test',
		...
		subscanAPI: 'https://gmordie.api.subscan.io'
	},
	[network.HEIKO]: {
		blockTime: 13000,
		category: 'kusama',
		...
		subscanAPI: 'https://heiko.api.subscan.io'
	},
	[network.HYDRADX]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://hydradx.api.subscan.io'
	},
	[network.KARURA]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://karura.api.subscan.io'
	},
	[network.KYLIN]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://kylin.api.subscan.io'
	},
	[network.KHALA]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://khala.api.subscan.io'
	},
	[network.KILT]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://spiritnet.api.subscan.io'
	},
	[network.MANTA]: {
		blockTime: 12000,
		category: 'solo',
		...
		subscanAPI: 'https://manta.api.subscan.io'
	},
	[network.MOONBASE]: {
		blockTime: 12000,
		category: 'test',
		...
		subscanAPI: 'https://moonbase.api.subscan.io'
	},
	[network.SHIBUYA]: {
		blockTime: 12000,
		category: 'test',
		...
		subscanAPI: 'https://shibuya.api.subscan.io'
	},
	[network.MOONBEAM]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://moonbeam.api.subscan.io'
	},
	[network.MOONRIVER]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://moonriver.api.subscan.io'
	},
	[network.MYRIAD]: {
		blockTime: 6000,
		category: 'solo',
		...
		subscanAPI: 'https://explorer.api.mainnet.oct.network/myriad'
	},
	[network.PARALLEL]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://parallel.api.subscan.io'
	},
	[network.PENDULUM]: {
		blockTime: 12000,
		category: 'polkadot',
		...
		subscanAPI: 'https://pendulum.api.subscan.io'
	},
	[network.POLKADEX]: {
		blockTime: 12000,
		category: 'solo',
		...
		subscanAPI: 'https://polkadex.api.subscan.io'
	},
	[network.POLYMESH]: {
		blockTime: 6000,
		category: 'solo',
		...
		subscanAPI: 'https://polymesh.api.subscan.io'
	},
	[network.POLYMESHTEST]: {
		...
		subscanAPI: 'https://api.polymesh-test.subscan.io'
	},
	[network.PICASSO]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://picasso.api.subscan.io'
	},
	[network.PICHIUROCOCO]: {
		...
		subscanAPI: 'https://api.pichiu-rococo.subscan.io'
	},
	[network.PICHIU]: {
		blockTime: 12000,
		category: 'test',
		...
		subscanAPI: 'https://pichiu.api.subscan.io'
	},
	[network.ROBONOMICS]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://robonomics.api.subscan.io'
	},
	[network.SHIBUYA]: {
		blockTime: 12000,
		category: 'test',
	...
	[network.SHIDEN]: {
		...
		subscanAPI: 'https://shiden.api.subscan.io'
	},
	[network.SNOW]:{
		blockTime: 12000,
		chainId: 0,
		...
		subscanAPI: 'https://snow.api.subscan.io'
	},
	[network.TANGANIKA]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://tanganika.api.subscan.io'
	},
	[network.TIDECHAIN]: {
		blockTime: 12000,
		category: 'test',
		...
		subscanAPI: 'https://tidechain.api.subscan.io'
	},
	[network.TURING]: {
		blockTime: 12000,
		category: 'kusama',
		...
		subscanAPI: 'https://turing.api.subscan.io'
	},
	[network.VARA]: {
		blockTime: 2000,
		category: 'test',
		...
		subscanAPI: 'https://vara.api.subscan.io'
	},
	[network.WESTEND]: {
		blockTime: 6000,
		category: 'test',
		...
		subscanAPI: 'https://westend.api.subscan.io'
	},
	[network.XX]: {
		blockTime: 6000,
		category: 'solo',
		...
		subscanAPI: 'https://xx.api.subscan.io'
	}
};
