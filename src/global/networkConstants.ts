...
export const chainProperties: types.ChainPropType = {
	[network.POLKADOT]: {
		...
		ss58Format: 0,
		subsquidUrl: process.env.POLKADOT_ASSETHUB_UNIFIED_SQUID_URL || '',
		tokenDecimals: 10,
	...
	[network.KUSAMA]: {
		...
		ss58Format: 2,
		subsquidUrl: process.env.KUSAMA_ASSETHUB_UNIFIED_SQUID_URL || '',
		tokenDecimals: 12,
	...
	[network.CERE]: {
		...
		ss58Format: 54,
		subsquidUrl: 'http://34.32.0.95:4354/graphql',
		tokenDecimals: 10,
	...
	[network.MOONRIVER]: {
		...
		ss58Format: 1285,
		subsquidUrl: 'http://34.32.0.95:4350/graphql',
		tokenDecimals: 18,
