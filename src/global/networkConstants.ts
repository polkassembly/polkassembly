...
export const chainProperties: types.ChainPropType = {
    ...
    [network.CENTRIFUGE]: {
        ...
        ss58Format: 36,
        subsquidUrl:
            "https://squid.subsquid.io/centrifuge-polkassembly/graphql",
        tokenDecimals: 18,
    ...
    [network.COLLECTIVES]: {
        ...
        ss58Format: 0,
        subsquidUrl:
            "https://squid.subsquid.io/collectives-polkassembly/graphql",
        tokenDecimals: 10,
        tokenSymbol: tokenSymbol.DOT,
        treasuryProposalBondPercent: null,
        treasuryProposalMinBond: null,
    ...
    [network.EQUILIBRIUM]: {
        ...
        subsquidUrl:
            "https://squid.subsquid.io/equilibrium-polkassembly/graphql",
        treasuryProposalBondPercent: null,
        treasuryProposalMinBond: null,
        treasuryProposalMaxBond: null,
    ...
    [network.INTEGRITEE]: {
        ...
        ss58Format: 13,
        subsquidUrl:
            "https://squid.subsquid.io/integritee-polkassembly/graphql",
        tokenDecimals: 12,
    ...
    [network.ROBONOMICS]: {
        ...
        ss58Format: 32,
        subsquidUrl:
            "https://squid.subsquid.io/robonomics-polkassembly/graphql",
        tokenDecimals: 9,
