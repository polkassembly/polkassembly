...
export const makeStore = () => {
	...
	if (isServer) {
		...
		const persistConfig = {
			...
			whitelist: ['userDetails', 'userUnlockTokensData', 'currentTokenPrice', 'tipping', 'gov1TreasuryProposal', 'trackLevelAnalytics'] // make sure it does not clash with server keys
		};
