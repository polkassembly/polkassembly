					...
					? popupContent
						...
						: <>
							<div className={'description display_inline flex items-center'}>
								...
								<span title={mainDisplay || encoded_addr} className={`max-w-[85px] flex gap-x-1 text-blue-light-high dark:text-blue-dark-high font-semibold ${textClassName}`}>
									...
									!disableHeader ?
										<Space className={'header'}>
											...
											<span className='identityName max-w-[85px] flex flex-col gap-y-1'>
												{ t2 && <span className={`${textClassName} truncate text-blue-light-high dark:text-blue-dark-high font-semibold`}>{ t2 }</span> }
												{!extensionName && sub && isSubVisible && <span className={`${textClassName} sub truncate text-blue-light-high dark:text-blue-dark-high font-semibold`}>{sub}</span>}
											</span>
										</Space>
										: null
								}
