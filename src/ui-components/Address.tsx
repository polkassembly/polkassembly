			...
			<div className='flex items-center text-bodyBlue'>
				{displayInline ? (
						...
						{!!kiltName ||
							(!!identity && !!mainDisplay && (
								<IdentityBadge
									...
									address={address}
									addressShort={!showFullAddress ? shortenAddress(encodedAddr, addressMaxLength) : encodedAddr}
									identity={identity}
									flags={flags}
					...
					<div className='ml-0.5 font-semibold text-bodyBlue'>
						...
						<div
							className={`${addressClassName} ${!disableAddressClick ? 'hover:underline' : 'cursor-pointer'} text-xs font-normal`}
							onClick={(e) => handleClick(e)}
						>
