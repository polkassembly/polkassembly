			...
			<div className='flex flex-col justify-center pb-5 pt-10'>
				<div className='mx-auto -mt-72'>
					<Image
						...
						height={320}
					/>
					<p className={`-mt-4 text-xl ${poppins.className} ${poppins.variable} font-semibold text-[#243A57] dark:text-blue-dark-high`}>{t('confusion_everywhere')}</p>
				</div>
				<div className='mx-auto -mt-3'>
					<div className='relative h-12 w-[480px]'>
						...
						<div className='absolute inset-0 left-5 top-5 z-10 '>
							<div className=''>
								<p className='font-poppins text-[14px] text-[#485F7D]  dark:text-[#7D7C81]'>{t('add_message')}</p>
							</div>
							<textarea
								name='content'
								className={
