...
const CreationLabel: FC<ICreationLabelProps> = (props) => {
	...
	return (
		<div className={`${className} flex w-[100%] justify-between bg-none`}>
			<div className={`text-xs ${isRow ? 'flex-row' : 'flex-col'} flex-wrap gap-y-3 max-sm:flex-wrap max-sm:gap-1 md:flex-row md:items-center`}>
				...
				<div className='details-container mt-2 flex items-center text-lightBlue dark:text-blue-dark-medium max-xs:ml-1'>
					...
					{created_at && (
						<span className={`${inPostHeading ? '-ml-[4px]' : 'mr-1'} flex items-center md:pl-0 ${isRow ? 'mt-0' : 'xs:mt-2 md:mt-0 md:pl-0'}`}>
