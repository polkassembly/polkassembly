			...
			{isSearch ? (
				...
				>
					<Image
						...
						alt='Logo'
					/>
					<span className='hidden text-sm font-normal capitalize leading-[18px] tracking-[0.02em] text-blue-light-high dark:text-blue-dark-high lg:ml-[9.25px] lg:mr-[13.35px] lg:flex lg:items-center lg:justify-center'>
						{network}
					</span>
