    ...
    const items: TimelineItemProps[] = historyData?.map((item, index) => {
        ...
        return {
            children: !item?.expanded ? (
                <div
                    className={
                        "text-[#334D6E] h-[50px] ml-3 text-sm tracking-[0.01em] flex flex-col gap-2 -mt-1 font-medium max-sm:w-full max-sm:ml-0"
                    }
                >
                    Edited on {getRelativeCreatedAt(date)}
                    <div
                        className="text-pink_primary text-sm flex justify-start cursor-pointer -mt-2"
                        onClick={() =>
                ...
                <div
                    className={`py-3 px-3 bg-white rounded-[4px] mt-1 border-solid border-[0.5px] border-[#D2D8E0] ml-3 max-sm:w-full max-sm:ml-0 ${
                ...
                >
                    <div className="flex items-center max-sm:flex-col max-sm:justify-start max-sm:gap-2  max-sm:items-start">
                        <div className="flex items-center max-sm:justify-start">
                            <span className="mr-1 text-xs text-[#90A0B7]">
                                By:
                            </span>
                            <NameLabel
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="flex items-center text-xs">
                                <span className="text-navBlue text-xs">
                    ...
                    <div
                        className={`mt-1 text-[#243A57] text-sm font-normal tracking-[0.01em] ${
                    ...
                    {item?.content.length > 100 && (
                        <span
                            onClick={() =>
                                handleExpand(index, EExpandType.ExpandedContent)
                            }
