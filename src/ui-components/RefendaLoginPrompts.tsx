    ...
    <div>
      <Modal
        ...
        footer={[
          <div
            key="1"
            className="justify-center center-aligned flex flex-col items-center gap-4 pb-8  mt-[32px]"
          >
            <Button
      ...
      >
        <div className="flex flex-col items-center p-1">
          <Image width={280} height={221} src={`${image}`} alt="" />
          <h5 className="text-[20px] leading-24 traking-normal mt-[32px] font-semibold max-sm:text-[16px]">
            {title}
          </h5>
          <h5 className="text-[14px] tracking-normal font-medium leading-21 font-poppins max-sm:text-[12px]">
            {subtitle}
          </h5>
        </div>
      </Modal>
