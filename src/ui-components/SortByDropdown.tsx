...
const SortByDropdownComponent: React.FC<SortByDropdownProps> = ({ setSortBy, isUsedInTrackListing, className }) => {
	...
	return (
		...
		>
			<div className='dropdown-div flex cursor-pointer items-center whitespace-pre rounded py-1 pl-2 text-xs font-normal text-bodyBlue opacity-70 dark:text-[#96A4B6] dark:opacity-100 sm:px-2 sm:pl-0'>
