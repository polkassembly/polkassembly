...
const UserDropdown = ({ address, className, displayInline, extensionName, popupContent, disableAddress, textClassName, shortenAddressLength, isShortenAddressLength = true, disableHeader, disableAddressClick, isSubVisible = true, addressClassName, clickable=true , truncateUsername = true, otherTextType, otherTextClassName, passedUsername = '', isVoterAddress }: Props): JSX.Element => {
