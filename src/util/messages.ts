...
const messages = {
  ...
  SUBSQUID_FETCH_ERROR:
    'Something went wrong while fetching onchain data. Please try again later.',
  ...
  VALIDATION_USERNAME_MAXLENGTH_ERROR:
    'Username cannot be larger than 30 characters.',
  VALIDATION_USERNAME_MINLENGTH_ERROR:
